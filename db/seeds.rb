...
user_1 = User.create({username: 'DeborahWei', password: 'password'})
...
pin_14 = Pin.safe_create({title: "Sunset, horizon, clean sky, glacier, mountains, nature, 1080x2160 wallpaper", description: "Download Sunset, horizon, clean sky, glacier, mountains, nature 1080x2160 wallpaper, Honor 7X, Honor 9 Lite, Honor View 10, 18067"}, user_2.id)[0]
...
pin_15 = Pin.safe_create({title: "Nature's beauties.", description: "“Every soul are here to blossom in it's unique way despite the darkness , the sufferings , the illusions ......... Because whenever the time comes to blossom ,it will bloom despite all unpromising surroundings.”"}, user_2.id)[0]
...
pin_16 = Pin.safe_create({title: "Fin Décembre - Le cottage de Gwladys", description: "En dépit de tout ce que nous avons traversé, essayons de finir ce mois de Décembre avec de la douceur et la couleur rose... Rose comme la..."}, user_2.id)[0]
...
pin_18 = Pin.safe_create({title: "〚 Delicate festive home in Spain 〛◾ Photos ◾ Ideas ◾ Design", description: "Next House- on to the Conservatory"}, user_2.id)[0]
...
pin_19 = Pin.safe_create({title: "TheFullerView", description: "Haverford residence addition, PA. Archer & Buchanan Architecture.Tom Crane Photography."}, user_2.id)[0]
...
pin_20 = Pin.safe_create({title: "Chairish Blog", description: "Whether they face outside or divide indoor spaces, French doors add a unique decorative touch to a home. See 30 of our favorite French door designs from the Dering Hall Lookbook."}, user_2.id)[0]
...
pin_22 = Pin.safe_create({title: "Bedroom with a gorgeous view - Cozy & Comfy", description: "Bedroom Inspiration for Kate Beavis Your Vintage Life vintage blogger, writer and speaker on homes, fashion, weddings and lifestyle."}, user_2.id)[0]
...
pin_23 = Pin.safe_create({title: "Bellezza, Stile, Estate {Daily Inspiration}", description: "Explore thebrightguy's photos on Flickr. thebrightguy has uploaded 415 photos to Flickr."}, user_2.id)[0]
...
pin_24 = Pin.safe_create({title: "Fairytale Wedding at Oheka Castle", description: "Real weddings and styled photoshoots are featured here for inspiration in planning your luxury wedding."}, user_2.id)[0]
...
pin_27 = Pin.safe_create({title: "Summertime Inspiration: Somewhere by the Sea :: This Is Glamorous", description: "Weekday Wanderlust | Summertime Inspiration: Somewhere by the Sea - from Positano to the Amalfi Coast, Mykonos, Kikladhes, Greece and Los Angeles"}, user_3.id)[0]
...
pin_28 = Pin.safe_create({title: "Uma casa onde o mediterrâneo e o industrial se encontram", description: "Propriedade na região do Algarve, em Portugal, tem ambientes despojados com notas de sofisticação"}, user_3.id)[0]
...
pin_30 = Pin.safe_create({title: "Friday Inspiration: The Outdoors + The Heart of the Home - Studio McGee", description: "Friday Inspiration: The Outdoors + The Heart of the Home"}, user_3.id)[0]
...
pin_32 = Pin.safe_create({title: "Beautiful orange and pink sunset", description: "Sunset aesthetic, beautiful sunset, pink sunset, orange sunset, clouds, nature, travel, hike, hiking, sun, sunrise, sunset pretty, gorgeous sunsets, beach sunset, mountain sunset, california sunset"}, user_3.id)[0]
...
pin_33 = Pin.safe_create({title: "paradisee | Aesthetic pictures, Scenery, Summer vibes", description: "Mar 4, 2021 - This Pin was discovered by Christina. Discover (and save!) your own Pins on Pinterest"}, user_4.id)[0]
...
pin_34 = Pin.safe_create({title: "atardeceres tumblr | Sky aesthetic, Sunset pictures, Nature photography", description: "Sun Sky Sunset Clouds background"}, user_4.id)[0]
...
pin_35 = Pin.safe_create({title: "Sunset Mother's Nature Style", description: "A firey sunset over the headland at Venus Bay, South Australia"}, user_4.id)[0]
...
pin_36 = Pin.safe_create({title: "Fire in the Sky", description: "threemonthsandaday: “ dusty ”"}, user_4.id)[0]
...
pin_37 = Pin.safe_create({title: "Into the Wildfire", description: "threemonthsandaday: “ dusty ” "}, user_4.id)[0]
...
pin_38 = Pin.safe_create({title: "Pin de Laia Calafat Nieto en sfondi en 2022 | Mandalas in 2022 | Sky aesthetic, Sunset pictures, Sky pictures", description: "May 27, 2021 - This Pin was discovered by noebrigit. Discover (and save!) your own Pins on Pinterest"}, user_4.id)[0]
...
pin_39 = Pin.safe_create({title: "Watch more sunsets than Netflix | Summer photos, Summer pictures, Summer friends", description: "Feb 9, 2022 - Jul 1, 2020 - This Pin was discovered by .. Discover (and save!) your own Pins on Pinterest"}, user_5.id)[0]
...
pin_40 = Pin.safe_create({title: "summer sunset 🌅 | Fotografi pantai, Wallpaper pantai, Fotografi alam", description: "2020 Agu 20"}, user_5.id)[0]
...
pin_41 = Pin.safe_create({title: "sunset sunrise | Sunrise pictures, Sunset pictures, Sky aesthetic", description: "Sep 6, 2021 - This Pin was discovered by ѕ. Discover (and save!) your own Pins on Pinterest"}, user_5.id)[0]
...
pin_42 = Pin.safe_create({title: "zking1 | Beach sunset wallpaper, Sunset pictures, Sky aesthetic", description: "May 20, 2020 - This Pin was discovered by RJDigital - travel blog. Discover (and save!) your own Pins on Pinterest"}, user_6.id)[0]
...
pin_43 = Pin.safe_create({title: "Pin by Mary Rivero on Almacenamiento rápido | Sky aesthetic, Beautiful landscape wallpaper, Beach sunset w… in 2022 | Sky aesthetic, Beach sunset wallpaper, Sunset pictures", description: "cotton candy cloud sky"}, user_6.id)[0]
...
pin_44 = Pin.safe_create({title: "hot choccy | Sky photography nature, Sky aesthetic, Sky photography", description: "A Very Exciting Sunset"}, user_6.id)[0]
...
pin_45 = Pin.safe_create({title: "@angelasunn_ ♥ | Summer pictures, Summer friends, Summer photos", description: "Pin by 김진현 on 감성 | Sky aesthetic, Sky pictures, Sunset pictures"}, user_6.id)[0]
...
pin_46 = Pin.safe_create({title: "Pin by :)) on sunset in 2022 | Sky aesthetic, Sunset pictures, Beach sunset wallpaper", description: "Los mejores fondos de pantalla para viajeros"}, user_6.id)[0]
...
pin_47 = Pin.safe_create({title: "Pin by Carla Macías on sunset | Beautiful beach pictures, Sunset pictures, Sky aesthetic", description: "Packer Meadow Sunset"}, user_6.id)[0]
...
pin_48 = Pin.safe_create({title: "Pin by MrsBad on ᴡ ᴀ ʟ ʟ ᴘ ᴀ ᴘ ᴇ ʀ s | Sky aesthetic, Sunset pictures, Nature photography", description: "There are so many stunning locations in Africa, in this article we share 7 of them ranging from all over the African continent!"}, user_6.id)[0]
...
pin_49 = Pin.safe_create({title: "Cheddar short crust pastry", description: "short crust pastry with cheddar cheese"}, user_7.id)[0]
...
pin_51 = Pin.safe_create({title: "Brown Sugar Peach Crumble Pie - Sally's Baking Addiction", description: "Homemade peach crumble pie is made with sweet brown sugar and warm cinnamon spice. Top each slice of brown sugar peach crumble pie with vanilla ice cream!"}, user_7.id)[0]
...
pin_54 = Pin.safe_create({title: "Lemon Sugar Coconut Cream Pie.", description: "137 reviews · 35 minutes · Serves 8 · Every bite is full of cool creamy coconut pudding and crunchy toasted coconut...the best a spring/summer pie can offer!"}, user_7.id)[0]
...
pin_55 = Pin.safe_create({title: "Pie-Crust-Design-Before-After-Part-2-Karin-Pfeiff-Boschek", description: "German baker and photographer Karin Pfeiff-Boschek takes pastry baking to a whole new level that is definitely close to pie-fection. She masterfully arranges dough and fruits into the most beautiful pie crust designs. Vibrant botanical and geometrical ornaments on top of delicious pies make them almost too pretty to eat."}, user_7.id)[0]
...
pin_58 = Pin.safe_create({title: "Instagram's Most Stunning Pie Crusts Come from a Self-Taught Baker", description: "We can't stop scrolling through these incredible pie designs."}, user_7.id)[0]
...
pin_59 = Pin.safe_create({title: "Blueberry Sour Cream Crumble Pie", description: "This blueberry sour cream pie is the best blueberry pie ever! Sweet sour cream custard, fresh blueberries, and a crumble topping. It will be the best Thanksgiving Pie you make this year! "}, user_4.id)[0]
...
pin_61 = Pin.safe_create({title: "Strawberry Rhubarb Pie with Crumb Topping", description: "39 reviews · 1.5 hours · Serves 8 · Strawberry Rhubarb Pie with Crumb Topping is the perfect summertime pie. Perfectly tart and sweet, piled high in my Flaky-All Butter Crust."}, user_6.id)[0]
